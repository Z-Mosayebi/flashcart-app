...
const en = {
  ...
  "card.streak": "Correct in a row",
  "settings.cardSounds": "Card sounds",
  "settings.cardSoundsHint": "Dealing, flipping and result sounds in Review.",
  ...
  "wait.review.working": "Checking your answer…",
  "wait.review.still": "Still checking — looking at grammar and word order…",
  "wait.review.busy": "The free AI is busy right now — this can take up to a minute. Your answer is safe, please wait.",
  "wait.tutor.working": "Your tutor is thinking…",
  "wait.tutor.still": "Still thinking about your sentence…",
  "wait.tutor.busy": "The free AI is busy right now — this can take up to a minute. Please wait, your message is safe.",
  ...
  "tutor.lesson": "Lesson",
  "tutor.words": "Words",
  "tutor.step": "Step {n} of {total}",
  "tutor.backToReview": "Back to Review",
...
const de: Record<TranslationKey, string> = {
  ...
  "card.streak": "Richtig in Folge",
  "settings.cardSounds": "Kartengeräusche",
  "settings.cardSoundsHint": "Geräusche beim Austeilen, Umdrehen und für das Ergebnis.",
  ...
  "wait.review.working": "Deine Antwort wird geprüft…",
  "wait.review.still": "Wird noch geprüft — Grammatik und Wortstellung…",
  "wait.review.busy": "Die kostenlose KI ist gerade ausgelastet — das kann bis zu einer Minute dauern. Deine Antwort ist sicher, bitte warte.",
  "wait.tutor.working": "Dein Tutor denkt nach…",
  "wait.tutor.still": "Denkt noch über deinen Satz nach…",
  "wait.tutor.busy": "Die kostenlose KI ist gerade ausgelastet — das kann bis zu einer Minute dauern. Bitte warte, deine Nachricht ist sicher.",
  ...
  "settings.goalPremium": "Premium",
  "tutor.masteredXp": "+25 XP",
  "tutor.lesson": "Lektion",
  "tutor.words": "Wörter",
  "tutor.step": "Schritt {n} von {total}",
  "tutor.backToReview": "Zurück zum Wiederholen",
